...
const services = [
  {
    ...
    description: "Широкий выбор цветов. Качественная заводская покраска или уф печать.",
    path: "/signage"
  },
  {
    icon: "Home",
    title: "Интерьерная реклама",
    description: "Оформляем стены и стеклянные перегородки вашим логотипом и фирменным стилем. Можно сделать прозрачными, матовыми или с изображением. Печатаем напрямую на материале и на пленке.",
    path: "/interior"
  },
  {
    icon: "Truck",
    title: "Брендирование транспорта",
    description: "Частичная оклейка коммерческих авто виниловой пленкой. Используем прочные плёнки, которые хорошо держатся на поверхности. Не боятся моек, дождя и солнца. Печатаем яркую графику, которая не выгорает на солнце. Оклейка служит 1–5 лет. Можно спокойно мыть на автомойке.",
    path: "/transport"
  },
  {
    icon: "Flag",
    title: "Баннеры и штендеры",
    description: "Используем прочные металлические каркасы с покрытием. Для уличных штендеров по запросу добавляем утяжелители, чтобы не упали от ветра.",
    path: "/banners"
  },
  {
    icon: "PenTool",
    title: "Разработка дизайна и согласование вывесок",
    description: "Покажем, как будет выглядеть вывеска на вашем здании ещё до изготовления. Создадим несколько вариантов на выбор, чтобы вы выбрали идеальный. Подготовим дизайн так, чтобы печать и производство прошли без ошибок. Цвета будут такими, как вы задумали.",
    path: "/design"
  },
  {
    icon: "Wrench",
    title: "Монтаж и установка",
    description: "Установим вывеску на высоте безопасно. Используем спецтехнику и страховку. Огородим рабочую зону, чтобы никто не пострадал.",
    path: "/installation"
  }
];
