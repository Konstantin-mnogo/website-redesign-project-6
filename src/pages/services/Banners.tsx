  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content="Изготовление баннеров и штендеров в Благовещенске. Широкоформатная печать, Roll-up стенды, X-баннеры, мобильные рекламные конструкции. Работаем по всей Амурской области." />
        <meta name="keywords" content="баннеры, штендеры, баннеры Благовещенск, roll up стенды, широкоформатная печать, X-баннеры, Свободный" />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-6">
              Баннеры и штендеры в Благовещенске
            </h1>
            ...
            <p className="text-lg text-gray-700 mb-8">
              Изготавливаем баннеры для фасадов, интерьеров и мероприятий, а также мобильные конструкции для быстрой смены рекламных сообщений. Работаем по всей Амурской области, включая Свободный.
            </p>
