            ...
            <div className="mb-12">
              ...
              <div className="space-y-4">
                ...
                <details className="bg-white rounded-lg shadow-md group">
                  ...
                  <div className="px-6 pb-6 text-gray-700">
                    Протирайте поверхность влажной тканью по мере необходимости. Не используйте абразивные средства. Карманы можно мыть мыльным раствором. Раз в месяц проверяйте крепления карманов и устойчивость конструкции. При правильном уходе стенд служит 5+ лет.
                  </div>
                </details>
